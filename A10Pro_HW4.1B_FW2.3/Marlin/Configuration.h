...
#define STRING_SPLASH_LINE1 USER_MODEL_NUMBER       // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 USER_WEBSITE_URL         // will be shown during bootup in line 2
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // A10M [@thinkyhead]
  #define  DEFAULT_Kp 25.22//226.93 //45.80
	#define  DEFAULT_Ki 2.68 //0.43  //3.61
	#define  DEFAULT_Kd 59.39 //854.89 //145.39
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 }   //Orig { 80, 80, 4000, 500 } 93*2 = DRV8825 1/32 Stepps //395 for Geetech extruder
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } //Orig { 300, 300, 5, 25 } //1.0.3 { 300, 300,20, 25 }
