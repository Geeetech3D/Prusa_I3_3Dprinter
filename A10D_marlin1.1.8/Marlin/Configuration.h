...
#define CUSTOM_MACHINE_NAME "A10D"
...
/**
 * Pru�a MK2 Single Nozzle Multi-Material Multiplexer, and variants.
 *
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0 //-0.50 // Z offset: -below +above  [the nozzle]
