...
extern uint8_t active_extruder;
  ...
  extern float mixing_factor[MIXING_STEPPERS];
    ...
    typedef struct {
      int16_t rate[3], rate_buf[3]; // Buffer used for tool change
      int counts;
...
#if INTEGRATED_FW
extern bool level_sensor_enabled;
extern bool bltouch_endstop_flag;
#endif
