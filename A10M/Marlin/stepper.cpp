...
#if 1  
mixer_t mixer;
enum Hotend_Enum { NOZZLE0=0, NOZZLE1=1, NOZZLE2=2, BED=3 };
...
//float get_current_position(unsigned char axis)
//{
//  basic_axis_position[axis] = count_position[axis];
//}
#define TEMPLATE_1 1
#define TEMPLATE_2 2
#define TEMPLATE_3 3
  ...
  switch(color_change_flag)
    {
      case 0:return;
      case TEMPLATE_1:
        start_p = (unsigned char)mixer.max;
        end_p = (unsigned char)mixer.min;
...
static unsigned char Nozzle_Select(void)
{
  unsigned char div;
  unsigned char nozzle_select = NOZZLE0 ;
  if(mixer.rate[NOZZLE0] >= 100) 
  {
    nozzle_select = NOZZLE0;
    return nozzle_select;
  }
