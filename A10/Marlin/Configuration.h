...
#define STRING_CONFIG_H_AUTHOR "(geeetech, A10)" // Who made the changes.
...
#define INVERT_Y_DIR  false//true    // for Mendel set to true, for Orca set to false
