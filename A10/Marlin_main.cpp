...
void loop()
{
  ...
  if(buflen)
  {
	...
	if((buflen==0)&&(recovery==1))
	{
		 //////////////////
		  ...
		  sprintf_P(tmp_y,PSTR("M190 S%d"),B_t);
		  SERIAL_ECHOLN(tmp_y);
		  enquecommand(tmp_y);
		  //////////////
		 //////////////////
  ...
  if((buflen==0)&&(recovery==2))
  {
     //////////////////
      char tmp_y[20];
      sprintf_P(tmp_y,PSTR("M32 S%d !%s"),pos_t,card.file_name_t);
      SERIAL_ECHOLN(tmp_y);
      enquecommand(tmp_y);
      //////////////
     //////////////////
...
void process_commands()
{
  ...
  else if(code_seen('M'))
  {
    ...
    card.openFile("reco.txt",false);
		sprintf_P(tmp_d,PSTR("%d,%d,%d,%d,%d,"),Z_t,E_t,pos_t,T0_t,B_t);
  ...
  *st_end='\0';
  ...
  ////
	...
	//////////////////
  SERIAL_ECHOLN("====");
  SERIAL_ECHOLN(card.file_name_t);
  recovery=1;
  ...
  enquecommand(tmp_n);
  //////////////////
  sprintf_P(tmp_n,PSTR("G92 E%d"),E_t);
  SERIAL_ECHOLN(tmp_n);
  enquecommand(tmp_n);
  //////////////
  //////////////////
...
case 404:  //M404 Enter the nominal filament width (3mm, 1.75mm ) N<3.0> or display nominal filament width 
    ...
    break;
    case 2000: // M2000 set SN and save
    {
        memcpy(uuid_sn,cmdbuffer[bufindr]+6,sizeof(uuid_sn));
		Config_StoreSettings();
        Config_RetrieveSettings();
    }
